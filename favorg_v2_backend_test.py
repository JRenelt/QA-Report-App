...
class FavOrgAPITester:
    ...
    def test_bookmark_lock_unlock_cycle(self):
        ...
        success, data = self.run_test("Create Bookmark for Lock Test", "POST", "bookmarks", 201, bookmark_data)
    ...
    def test_locked_bookmark_protection(self):
        ...
        success, data = self.run_test("Create Bookmark for Protection Test", "POST", "bookmarks", 201, bookmark_data)
    ...
    def test_status_type_locked(self):
        ...
        success, data = self.run_test("Create Bookmark for Status Test", "POST", "bookmarks", 201, bookmark_data)
