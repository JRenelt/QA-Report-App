...
const QADashboardV2: React.FC<QADashboardV2Props> = ({ 
  ...
  useEffect(() => {
    ...
    const loadTestSuitesFromBackend = async () => {
      try {
        const backendUrl = process.env.REACT_APP_BACKEND_URL || 'https://qa-report-portal.preview.emergentagent.com';
  ...
  // PDF Preview - VOLLSTÄNDIG ENTFERNT
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <div className="flex-1 flex flex-col overflow-hidden">
          ...
          <div className="bg-[#282C34] border-b border-gray-700 p-4 flex items-center justify-between">
            ...
            <div className="w-8"></div> {/* Spacer für Balance */}
          </div>
