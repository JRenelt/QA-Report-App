      ...
      >
        ...
        <div className="bg-gray-800 border-b border-gray-700 p-4 flex items-center justify-between" style={{ minHeight: '50px' }}>
          ...
          <div className="flex items-center gap-2">
            ...
            <Button onClick={handleRemoveTest} size="sm" variant="outline" className="bg-red-600 hover:bg-red-700 text-white border-red-600 text-xs px-2 py-1" title="Der benannte Test wird endgültig entfernt">
              ×
            </Button>
          </div>
        </div>
            ...
            <>
              ...
              <div className="w-72 bg-gray-800 border-r border-gray-700 p-3 overflow-y-auto">
                <div className="flex items-center justify-between mb-3">
                  ...
                  <span className="bg-orange-600 text-white px-2 py-1 rounded text-xs font-bold" title="Noch zu erledigende Testpunkte">
