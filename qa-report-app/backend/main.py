...
# Route imports
from routes import auth, users, companies, projects, test_suites, test_cases, test_results, import_export, pdf_reports, archive
...
app.include_router(archive.router, prefix="/api/archive", tags=["Archive Management"])
